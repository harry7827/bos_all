...
public class Customer {
	@Id
	/*@SequenceGenerator(name = "mySeq", sequenceName = "customer_seq", initialValue = 10, allocationSize = 1)
	@GeneratedValue(generator="customer_seq",strategy=GenerationType.SEQUENCE)*/
	@GeneratedValue(strategy = GenerationType.SEQUENCE,generator="mySeq")
	@SequenceGenerator(name = "mySeq", sequenceName = "customer_seq", initialValue = 20, allocationSize = 1)
	@Column(name = "C_ID")
