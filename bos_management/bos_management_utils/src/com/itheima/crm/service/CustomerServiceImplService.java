 ...
 * 
 */
@WebServiceClient(name = "CustomerServiceImplService", targetNamespace = "http://impl.service.crm.itheima.com/", wsdlLocation = "http://localhost:8888/crm/cxf/customer?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8888/crm/cxf/customer?wsdl");
    ...
    public CustomerService getCustomerServiceImplPort() {
        return super.getPort(new QName("http://impl.service.crm.itheima.com/", "CustomerServiceImplPort"), CustomerService.class);
    }
    ...
    public CustomerService getCustomerServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.service.crm.itheima.com/", "CustomerServiceImplPort"), CustomerService.class, features);
    }
